...
angular.module('beer.service').factory('googleLogin', [
    '$http', '$q', '$interval', '$log', 'timeStorage',
    function($http, $q, $interval, $log, timeStorage) {
        var service = {};
        service.access_token = false;
        service.redirect_url = 'http://localhost/demo1/demo';
        service.client_id = '86285624834-atvl4kh7jsn12qb88lpkqbdsjbdqv570.apps.googleusercontent.com';
        service.secret = 'G1S47gTV9QGPoBUS3qxwkkut';
